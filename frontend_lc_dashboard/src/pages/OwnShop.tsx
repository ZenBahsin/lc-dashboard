...
import OwnShopTransactionTable from "../components/OwnShop/OwnShop_TransactionTable";
import OwnShopChannelContribution from "../components/OwnShop/OwnShop_ChannelContribution";
import OwnShopProductContribution from "../components/OwnShop/OwnShop_ProductContribution";
import OwnShopRevenueGrowth from "../components/OwnShop/OwnShop_RevenueGrowth";

const OwnShop: React.FC = () => {
    ...
    <>
      ...
      <FullScreen handle={handle}>
        <Box id="ownshopcorner">
          <Box m="8">
            <OwnShopTransactionTable filterParams={filterParams} />
          </Box>
          <SimpleGrid columns={{ base: 1, md: 2 }} spacing="8">
            <Box m="8">
              <OwnShopChannelContribution filterParams={filterParams} />
            </Box>
            <Box m="8">
              <OwnShopProductContribution filterParams={filterParams} />
            </Box>
          </SimpleGrid>
          <Box m="8">
            <OwnShopRevenueGrowth filterParams={filterParams} />
          </Box>
        </Box>
      </FullScreen>
    </>
